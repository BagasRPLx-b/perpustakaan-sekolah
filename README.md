...
Instal dan Jalankan MySQL Server di komputer Anda (misalnya melalui XAMPP, WAMP, atau instalasi langsung).
Buat Database Baru. Anda bisa menggunakan phpMyAdmin, MySQL Workbench, atau klien terminal MySQL. Misalnya, buat database dengan nama perpustakaan_sekolah:

CREATE DATABASE perpustakaan_sekolah;

Pilih database yang baru dibuat.
Buat Tabel-tabel. Jalankan skrip SQL berikut di database perpustakaan_sekolah Anda untuk membuat semua tabel yang diperlukan oleh aplikasi:
...
rontend akan berjalan di http://localhost:5173 (atau port lain jika 5173 digunakan).
